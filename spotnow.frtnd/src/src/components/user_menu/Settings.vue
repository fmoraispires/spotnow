  ...
  <div>
    <div class="container">
      <div class="intro-text">
        <!-- titulo-->
        <div class="intro-heading text-uppercase">Dados da Conta</div>
        <div class="intro-lead-in">Verifique os seus dados e altere-os se necessário</div>
        <v-card>
          <v-toolbar flat  dark>
          ...
          <v-tabs vertical>
            ...
            <v-tab>
              <v-icon left>mdi-garage</v-icon>As Suas Garagens
            </v-tab>
            <v-tab>
              <v-icon left>mdi-credit-point</v-icon>Métodos de Pagamento
            </v-tab>
            <v-tab>
              <v-icon left>mdi-access-point</v-icon>Reservas
            </v-tab>
